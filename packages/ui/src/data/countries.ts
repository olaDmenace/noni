...
export const COUNTRIES: Country[] = [
  ...
  { code: 'AS', dial: '+1684', flag: '🇦🇸', name: 'American Samoa' },
  ...
  { code: 'BM', dial: '+1441', flag: '🇧🇲', name: 'Bermuda' },
  ...
  { code: 'GU', dial: '+1671', flag: '🇬🇺', name: 'Guam' },
  ...
  { code: 'MS', dial: '+1664', flag: '🇲🇸', name: 'Montserrat' },
  ...
  { code: 'MP', dial: '+1670', flag: '🇲🇵', name: 'Northern Mariana Islands' },
  ...
  { code: 'BL', dial: '+590', flag: '🇧🇱', name: 'Saint Barthélemy' },
  ...
  { code: 'SX', dial: '+1721', flag: '🇸🇽', name: 'Sint Maarten' },
  ...
  { code: 'TC', dial: '+1649', flag: '🇹🇨', name: 'Turks and Caicos Islands' },
  { code: 'TV', dial: '+688', flag: '🇹🇻', name: 'Tuvalu' },
  { code: 'VI', dial: '+1340', flag: '🇻🇮', name: 'U.S. Virgin Islands' },
