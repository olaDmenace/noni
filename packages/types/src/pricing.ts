...
export const TIER_PRICING: Record<Tier, TierPricing> = {
  ...
  T2: { priceKobo: 15_000, agentCostKobo: 2_000, platformNetKobo: 13_000, durationSecs: 1200, isSubscription: false },
...
export const MIN_WALLET_TOPUP_KOBO = 10_000;   // ₦100 minimum top-up
